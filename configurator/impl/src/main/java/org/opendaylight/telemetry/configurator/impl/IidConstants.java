...
public final class IidConstants {

    private IidConstants() {
    ...
    public static final InstanceIdentifier<TelemetrySystem> TELEMETRY_SYSTEM_IID = InstanceIdentifier
            .create(TelemetrySystem.class);

    public static final InstanceIdentifier<Telemetry> TELEMETRY_IID = InstanceIdentifier
            .create(Telemetry.class);

    public static InstanceIdentifier<TelemetrySensorGroup> getSensorGroupPath(String sensorGroupId) {
    ...
    public static InstanceIdentifier<TelemetryDestinationGroup> getDestinationGroupPath(
            String destinationGroupId) {
        return InstanceIdentifier.create(Telemetry.class)
                .child(TelemetryDestinationGroup.class, new TelemetryDestinationGroupKey(destinationGroupId));
    }

    public static InstanceIdentifier<TelemetryNode> getNodeGroupPath(String nodeGroupId) {
        return InstanceIdentifier.create(Telemetry.class).child(TelemetryNode.class, new TelemetryNodeKey(nodeGroupId));
    }

    public static InstanceIdentifier<TelemetrySubscription> getSubscriptionPath(String nodeId, String name) {
    ...
    public static InstanceIdentifier<TelemetrySensor> getSubscriptionSensorPath(String nodeId, String name,
                                                                                      String sensorId) {
        return InstanceIdentifier.create(Telemetry.class).child(TelemetryNode.class, new TelemetryNodeKey(nodeId))
                .child(TelemetrySubscription.class, new TelemetrySubscriptionKey(name))
    ...
    public static InstanceIdentifier<TelemetryDestination> getSubscriptionDestinationPath(String nodeId,
                                                                                                String name,
